...
<main class="container">
 ...
 <div class="row">
  <div class="col-lg-12"><h1 class="heading text-center">Logout</h1>
   <div class="line"></div>
   <h5 class="heading text-center">You have now been logged out.</h5>
  </div>
...
<img src="//www.google.com/logos/Logo_25wht.gif"
border="0" alt="Google"></img></a>
</td>
<td nowrap="nowrap">
<input type="hidden" name="domains" value="my-diary.org"></input>
...
<td>
<input type="radio" name="sitesearch" value="my-diary.org"></input>
<font size="-1" color="#000000">my-diary.org</font>
</td>
</tr>
</table>
      ...
      <div class='col-lg-3'>
       <label for='exampleInputName2'>Email</label>
		...
		<div class='row'>
				...
				<div class='col-lg-10'>
			<div class='row'> <div class='col-lg-4'> <button type='submit' class='btn btn-default'><i class='fa fa-user-o'></i> Login</button></div>	
			 <div class='col-lg-8'><a href='/create/'> Not registered? <br>Sign up today</a></div>	</div>	
		  </div>
			</div>
	</div> 
   <div class='col-lg-4'>
